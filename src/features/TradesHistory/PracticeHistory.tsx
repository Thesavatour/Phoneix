...
function PracticeHistory() {
  ...
  const BlockTableData = practiceHistoryLogs.trade_practice_logs.map(
    (item, index) => (
      <Table.BlockRow
        key={index}
        data={{
    ...
    <>
      <Card>
        <div className="flex flex-wrap justify-between items-center gap-4 mb-4">
          <CardTitle title="Practice Logs History" />
        ...
        <div className="overflow-x-auto md:block hidden">
          <Table>
            ...
            {practiceHistoryLogs.trade_practice_logs.length === 0 && (
              <TableNoData />
            )}
            {practiceHistoryLogs.trade_practice_logs.map((item, index) => (
              <Table.Row key={index}>
        ...
        <div className="block md:hidden">
          {practiceHistoryLogs?.trade_logs?.length ? (
            BlockTableData
          ) : (
        ...
        {currentPage === 1 &&
        !practiceHistoryLogs.trade_practice_logs_meta.next_page_url ? null : (
          <Paginator
            currentPage={currentPage}
            onPageChange={handleChangePage}
            hasNextPage={
              practiceHistoryLogs.trade_practice_logs_meta.next_page_url !==
              null
            }
